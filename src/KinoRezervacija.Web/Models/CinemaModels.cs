...
public sealed record Movie(int Id, string Title, string Genre, int ReleaseYear, int DurationMinutes, string AgeRating, string Language, string SubtitleLanguage, string Description, decimal FromPrice, string Accent, bool IsFeatured = false, string PosterPath = "");
