...
public sealed class CinemaCatalogService
{
    private readonly List<Movie> _movies = [
        new(1, "Neona pilsēta", "Trilleris", 2026, 118, "16+", "Angļu", "Latviešu", "Pēc nakts lietus Rīga iemirdzas neona krāsās. Detektīve Mara atrod pavedienu, kas ved pāri pilsētai un pašai sev pāri.", 8.50m, "violet", true, "/images/posters/neona-pilseta.png"),
        new(2, "Mēness arhīvs", "Zinātniskā fantastika", 2026, 132, "12+", "Angļu", "Latviešu", "Uz pamestas Mēness stacijas atstāta balss ieraksta atklāj stāstu, kuru neviens nebija paredzējis dzirdēt.", 9.00m, "blue", false, "/images/posters/meness-arhivs.png"),
        new(3, "Vasaras otra puse", "Drāma", 2025, 104, "7+", "Latviešu", "Angļu", "Draudzība, kas sākas vienā vasarā, iemāca pieaugt daudz ātrāk nekā gribētos.", 7.50m, "gold", false, "/images/posters/vasaras-otra-puse.png"),
